...
![Flowchart if-else: kondisi → true ke blok if / false ke blok else → lanjut program](/images/if-else-flowchart.svg)
...
<Exercise client:load
  id="u2l2-ex1"
  title="Cek Lulus atau Tidak"
  description="Lengkapi program berikut dengan if-else agar mencetak <code>Lulus</code> jika nilai >= 75, atau <code>Tidak Lulus</code> jika tidak."
  type="code-output"
...
int main() {
  ...
  hints={["Sintaks: if (kondisi) { ... } else { ... }", "Kondisi yang dicek: nilai >= 75", 'std::cout << "Lulus" << std::endl;']}
  explanation="Karena nilai adalah 80 dan 80 >= 75 bernilai true, blok if dijalankan dan mencetak Lulus. Blok else dilewati."
  lang="id"
/>

<Exercise client:load
  id="u2l2-ex2"
  title="Pengecekan Kondisi if-else"
  description="Variabel x bernilai 0. Program mengecek: jika x > 0 cetak Positif, jika x &lt; 0 cetak Negatif, selain itu cetak Nol. Apa output yang dihasilkan?"
  type="multiple-choice"
  options={["Positif", "Negatif", "Nol", "Tidak ada output"]}
  correctIndex={2}
  hints={["x bernilai 0", "0 > 0 adalah false, 0 < 0 juga false", "Jika semua kondisi false, blok else yang dijalankan"]}
  explanation="Karena x = 0, kondisi x > 0 adalah false dan x < 0 juga false. Kedua kondisi gagal, sehingga blok else dijalankan dan mencetak Nol."
  lang="id"
/>
