...
<Exercise client:load
  id="u4l2-ex1"
  title="Return Type bool"
  description="Perhatikan fungsi ini: bool adalahGenap(int angka) { return angka % 2 == 0; } Apa yang dicetak oleh std::cout &lt;&lt; adalahGenap(4) &lt;&lt; std::endl; ?"
  type="multiple-choice"
  options={["true", "false", "1", "0"]}
  correctIndex={2}
  hints={["C++ mencetak bool sebagai angka secara default", "true dicetak sebagai 1, false dicetak sebagai 0", "4 % 2 == 0 bernilai true, dan true dicetak sebagai 1"]}
  explanation="Dalam C++, std::cout mencetak nilai bool sebagai angka secara default: true dicetak sebagai 1 dan false dicetak sebagai 0. Karena 4 adalah genap (4 % 2 == 0 adalah true), fungsi mengembalikan true, dan std::cout mencetak 1."
  lang="id"
/>

<Exercise client:load
  id="u4l2-ex2"
  title="Fungsi Keliling Persegi"
  description="Lengkapi fungsi hitungKelilingPersegi agar mencetak output yang benar."
  type="code-output"
  expectedOutput="Keliling persegi sisi 5: 20"
  starterCode={`#include <iostream>

int hitungKelilingPersegi(int sisi) {
    // Rumus keliling persegi: sisi * 4
    return sisi * 4;
}
...
int main() {
  ...
  hints={["Keliling persegi = sisi x 4", "Fungsi sudah ditulis dengan benar, coba jalankan", "5 * 4 = 20"]}
  explanation="Fungsi hitungKelilingPersegi menerima sisi sebagai parameter dan mengembalikan sisi * 4. Saat dipanggil dengan argumen 5, fungsi mengembalikan 20, dan hasilnya langsung ditampilkan di cout."
  lang="id"
/>
