...
<Exercise client:load
  id="u4l4-ex1"
  title="Fungsi Predikat"
  description="Fungsi yang mengembalikan bool disebut fungsi predikat. Apa output dari kode berikut? bool isPositive(int n) { return n &gt; 0; } std::cout &lt;&lt; isPositive(10) &lt;&lt; std::endl;"
  type="multiple-choice"
  options={["true", "false", "1", "0"]}
  correctIndex={2}
  hints={["C++ mencetak bool sebagai 1 (true) atau 0 (false) secara default", "10 > 0 bernilai true", "true dicetak sebagai angka 1"]}
  explanation="Fungsi isPositive(10) mengembalikan true karena 10 > 0. Namun, std::cout mencetak nilai bool sebagai angka secara default: true menjadi 1, false menjadi 0. Jadi outputnya adalah 1."
  lang="id"
/>

<Exercise client:load
  id="u4l4-ex2"
  title="Gunakan Return Value"
  description="Lengkapi program agar mencetak kuadrat dari angka 7."
  type="code-output"
  expectedOutput="Kuadrat 7 = 49"
...
int main() {
    // Simpan return value ke variabel hasil, lalu cetak
    int hasil = kuadrat(7);
    std::cout << "Kuadrat 7 = " << hasil << std::endl;
    return 0;
}`}
  hints={["Fungsi kuadrat sudah ada, tinggal simpan return value-nya", "int hasil = kuadrat(7);", "7 * 7 = 49"]}
  explanation="Fungsi kuadrat(7) mengembalikan 7 * 7 = 49. Return value disimpan di variabel hasil, lalu dicetak. Ini adalah cara paling umum menggunakan return value: simpan di variabel dulu, lalu gunakan."
  lang="id"
/>
